# DAKIA Academy - Style Guide

Hướng dẫn style và thiết kế UI cho DAKIA Academy.

## 🎨 Bảng Màu (Color Palette)

### AI Tech Blue - Primary Colors

DAKIA Academy sử dụng bảng màu **AI Tech Blue** để tạo cảm giác hiện đại, công nghệ và đáng tin cậy.
...
<h1 className="display-1 fw-bold mb-4">DAKIA Academy</h1>
