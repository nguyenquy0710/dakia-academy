...
Complete reference for DAKIA Academy's `.github/` folder.
...
```
┌────────────────────────────────────────────────────────────────────────────┐
│                    DAKIA ACADEMY CI/CD ARCHITECTURE                        │
├────────────────────────────────────────────────────────────────────────────┤
│                                                                            │
...
Examples:
  feat(courses): add video player with subtitles
  fix(auth): resolve login session timeout issue
  perf(api): optimize course query performance
  docs(readme): update installation instructions
  style(ui): improve course card responsive design
  refactor(db): simplify user model schema
...
|----------------------------------|---------------------------|-----------------------------|
| `src/app/(admin)/**`             | Admin E2E tests           | Admin panel functionality   |
| `src/app/(client)/**`            | Client E2E tests          | Public learning platform    |
| `src/lib/markdown/**`            | Markdown processing tests | Content rendering           |
| `src/models/**`, `src/lib/db/**` | Database integration tests| Data layer validation       |
...
**Environment**: https://dakia-academy.com (production)
